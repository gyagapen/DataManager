...
public class SharedPrefsEditor {
	...
	static final String STR_MANAGE_APP_IS_OPEN = "manageAppConnectivityIsOpen";
	...
	static final boolean MANAGE_APP_IS_OPEN = false;
	...
	public boolean isManageAppIsOpened() {
		return dataManagerSettings.getBoolean(STR_MANAGE_APP_IS_OPEN,
				MANAGE_APP_IS_OPEN);
	}
